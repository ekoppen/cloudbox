...
1	2025-08-02 18:08:24.901402+00	2025-08-02 18:08:24.901402+00	\N	2	1	2025-08-02 18:08:24.895452+00	main	completed	react	vite	typescript	npm	npm run build		npm run dev			80	{"API_KEY": "your_api_key_here_change_this", "API_PORT": "4000", "APP_NAME": "portfolio", "WEB_PORT": "80", "JWT_SECRET": "your_super_secret_jwt_key_change_this_in_production", "CONTENT_DIR": "./content", "MONGODB_PORT": "27017", "PROJECT_PREFIX": "portfolio", "MONGODB_DATABASE": "portfolio", "MONGODB_ROOT_PASSWORD": "password123"}	f	docker build -t photoportfolio .	0	\N	\N	\N	["package.json", "Dockerfile", "docker-compose.yml", "vite.config.ts", ".env.example", "README.md"]	\N	\N	[{"name": "npm", "port": 80, "command": "npm install", "description": "Standard npm installation", "dev_command": "npm run dev", "environment": {"API_KEY": "your_api_key_here_change_this", "API_PORT": "4000", "APP_NAME": "portfolio", "WEB_PORT": "80", "JWT_SECRET": "your_super_secret_jwt_key_change_this_in_production", "CONTENT_DIR": "./content", "MONGODB_PORT": "27017", "PROJECT_PREFIX": "portfolio", "MONGODB_DATABASE": "portfolio", "MONGODB_ROOT_PASSWORD": "password123"}, "build_command": "npm run build", "start_command": "", "is_recommended": true}, {"name": "custom", "port": 80, "command": "", "description": "Custom deployment configuration", "dev_command": "", "environment": {}, "build_command": "", "start_command": "", "is_recommended": false}]	["React application detected - make sure to set REACT_APP_ environment variables", "Vite detected - very fast build times expected", "Custom port 80 detected - make sure to configure your reverse proxy", "Environment variables detected - review and configure them for your deployment"]	\N	\N	0	0	4	\N
\.
