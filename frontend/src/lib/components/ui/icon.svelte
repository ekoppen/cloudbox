...
<span class="inline-flex items-center justify-center {className}" style="color: {color}">
  {#if name === 'cloud'}
  ...
  {:else if name === 'functions'}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M9 12h6"/>
      <path d="M9 16h6"/>
      <path d="M14 20H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v6"/>
      <path d="m20 16-2 2 2 2"/>
    </svg>
  ...
  {:else if name === 'crown'}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M11.562 3.266a.5.5 0 0 1 .876 0L14.5 8.5l4.062-2.5a.5.5 0 0 1 .769.536L18 18.5H6l-1.331-12.464a.5.5 0 0 1 .769-.536L9.5 8.5z"/>
    </svg>
  {:else if name === 'trash'}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M3 6h18"/>
