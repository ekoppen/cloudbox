...
func Handler(ctx context.Context, event Event) (Response, error) {
  ...
  async function loadFunctions() {
    loading = true;
    try {
      const response = await fetch(`http://localhost:8080/api/v1/projects/${projectId}/functions`, {
  ...
  async function deployFunction(functionId: number) {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/v1/projects/${projectId}/functions/${functionId}/deploy`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...auth.getAuthHeader()
  ...
  async function testFunction(functionId: number) {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/v1/projects/${projectId}/functions/${functionId}/execute`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...auth.getAuthHeader()
  ...
  async function showFunctionLogs(func) {
    try {
      const response = await fetch(`http://localhost:8080/api/v1/projects/${projectId}/functions/${func.id}/logs`, {
        headers: auth.getAuthHeader()
      });
  ...
  async function deleteFunction(functionId: number) {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/v1/projects/${projectId}/functions/${functionId}`, {
        method: 'DELETE',
        headers: auth.getAuthHeader()
      });
